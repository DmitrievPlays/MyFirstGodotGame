...
public partial class ResourceManager : Node
{
    ...
    public Dictionary<int, BaseItem> ResourcesDatabase = new(); //Resources main dictionary
    public Dictionary<string, int> Offsets = new(); //Resource ids offsets

    public async Task AddResource(Enum @enum, BaseItem resource) // Adds a single resource from an original list or a mod
    {
    ...
    public async Task<BaseItem> GetResource(Enum @enum)
    {
